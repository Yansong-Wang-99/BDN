...
hoc_file = "dend[8][10]asynchronous.hoc"
...
try:
    ...
    i_dend10_nA = np.array(h.i_dend10_vec)
    
    amp_dend8 = h.amp_dend8
    amp_dend10 = h.amp_dend10
...
title_text = (f"Soma Response and Stimulus Currents\n"
              f"dend[8] amp = {amp_dend8:.4f} nA, dend[10] amp = {amp_dend10:.4f} nA")
...
ax2.plot(time_ms, i_dend10_nA, color='blue', lw=1.5, label=f'Current @ dend[10]')
...
plt.savefig("dend[8][10]asynchronous.pdf", dpi=300, bbox_inches='tight')
plt.show()
