...
parser.add_argument('--experiment', default='gesture_classIL', type=str, required=False, choices=['mnist_classIL', 'cifar_classIL', 'gesture_classIL', 'alphabet_classIL', 'mathgreek_classIL'])
...
parser.add_argument('--gpu', type=str, default='1', help='Number of used gpu')
...
parser.add_argument('--sbatch', type=int, default=16)
...
parser.add_argument('--distribution',
                    ...
                    default='binary_tree',
                    required=False,
                    choices=['uniform', 'normal', 'beta', 'binary_tree']
                    )
